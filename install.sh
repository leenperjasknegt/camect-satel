...
echo "###################################################################"
echo
sudo apt update > file.log 2>&1
sudo apt-get -y install python3-pip > file.log 2>&1
echo
echo "###################################################################"
echo "Installing IntegraPy"
echo "###################################################################"
echo
sudo pip3 install IntegraPy > file.log 2>&1
echo
echo "###################################################################"
echo "Installing Wget"
echo "###################################################################"
echo
sudo apt install wget > file.log 2>&1
echo
echo "###################################################################"
echo "Downloading & copy files"
echo "###################################################################"
echo
wget https://raw.githubusercontent.com/leenperjasknegt/camect-satel/main/camect.service > file.log 2>&1
wget https://raw.githubusercontent.com/leenperjasknegt/camect-satel/main/demo.py > file.log 2>&1
sudo mv demo.py /usr/local/lib/python3.8/dist-packages/IntegraPy/demo.py > file.log 2>&1
sudo mv camect.service /etc/systemd/system/camect.service > file.log 2>&1
echo
echo "###################################################################"
...
echo "###################################################################"
echo
sudo systemctl stop camect.service > file.log 2>&1
sleep 2
sudo systemctl daemon-reload > file.log 2>&1
sleep 1
sudo systemctl enable camect.service > file.log 2>&1
echo
echo "###################################################################"
...
echo
sleep 1
sudo systemctl start camect.service > file.log 2>&1
echo
sleep 2
echo
